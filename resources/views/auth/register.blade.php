<x-guest-layout>
    @section('title', 'AuraCampus | Workspace Enrollment')
    ...
    <div class="min-h-screen w-screen flex flex-col items-center justify-center p-6 tech-canvas relative overflow-hidden select-none bg-[#fafbfc]">
        ...
        <div class="w-full max-w-[420px] p-8 rounded-2xl bg-white border border-slate-200/60 shadow-[0_1px_3px_rgba(0,0,0,0.01),0_24px_48px_-16px_rgba(15,23,42,0.08)] relative z-10 text-slate-800">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <!-- Name Input -->
                <div>
                    <label for="name" class="block text-xs font-medium text-slate-500 mb-1.5">Administrative Name</label>
                    <input 
                        id="name" 
                        type="text" 
                        name="name" 
                ...
                <!-- Password Input -->
                <div>
                    <label for="password" class="block text-xs font-medium text-slate-500 mb-1.5">Security Password</label>
                    <input 
                        id="password" 
                        type="password" 
                        name="password" 
