...
<div class="max-w-4xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="space-y-2">
            <a href="#" class="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-white border border-slate-200/60 shadow-sm text-violet-600 font-bold text-xs">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="address" rows="3"
                                      class="w-full px-4 py-2.5 premium-input rounded-xl text-xs font-medium focus:outline-none focus:premium-input-focus-violet resize-none">{{ old('address', $school->address) }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="timezone" required class="w-full px-4 py-2.5 premium-input rounded-xl text-xs font-medium focus:outline-none focus:premium-input-focus-violet appearance-none cursor-pointer bg-white">
                            ...
                            <div>
                                ...
                                <select name="grading_system" required class="w-full px-4 py-2.5 premium-input rounded-xl text-xs font-medium focus:outline-none focus:premium-input-focus-violet appearance-none cursor-pointer bg-white">
