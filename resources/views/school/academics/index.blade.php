...
<div class="premium-card p-8 rounded-2xl relative overflow-hidden bg-white">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        ...
        <button class="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl transition-all cursor-pointer shadow-sm">
            Configure Exams
        </button>
    </div>
    ...
    <div class="space-y-4 opacity-75">
        <div>
            <div class="flex justify-between items-center mb-1">
                ...
                <span class="text-xs font-mono font-bold text-emerald-600">78% Complete</span>
            </div>
            <div class="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                <div class="bg-gradient-to-r from-emerald-500 to-cyan-500 h-full" style="width: 78%"></div>
            </div>
        </div>
        <div>
            <div class="flex justify-between items-center mb-1">
    ...
    <div class="mt-8 p-6 border border-dashed border-slate-200 rounded-xl bg-slate-50/20 text-center">
        <span class="material-symbols-outlined text-emerald-600 text-4xl mb-3 animate-float-slow" data-icon="menu_book">menu_book</span>
