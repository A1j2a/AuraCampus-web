...
return [
    ...
    'title' => 'AuraCampus API Documentation',

    'description' => 'REST API for AuraCampus — School Management Platform. Supports Teacher, Parent and Student mobile app flows.',

    'intro_text' => <<<'INTRO'
            This documentation covers all API endpoints for the **AuraCampus** mobile application.
            ...
            **Authentication:** All protected endpoints require a Bearer token obtained from the login endpoint.
            ...
            <aside>Use the <b>Try It Out</b> button on each endpoint to test it directly from the browser.</aside>
        INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'Get your token by calling <b>POST /api/auth/login</b> and using the returned <code>token</code> value.',
    ],
